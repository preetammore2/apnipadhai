...
import { Quote, Award, Sparkles, Youtube, Send, CheckCircle2, ArrowRight } from 'lucide-react';
            ...
            >
              <div className="relative h-[430px] w-full rounded-3xl overflow-hidden border-2 border-yellow-400/40 shadow-2xl">
                <Image
                  ...
                  alt="Rohit Sir Founder Apni Padhai"
                  fill
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  ...
                  <p className="text-xs text-yellow-200 font-medium">Author of Bestselling Brahmastra Book Series</p>
                </div>
              </div>
              ...
              <div className="absolute -bottom-5 -right-5 bg-white text-navy-900 p-4 rounded-2xl shadow-2xl flex items-center gap-3 hidden sm:flex border border-yellow-300">
                ...
                <div>
                  <p className="text-xs font-black text-navy-900">10+ Years Experience</p>
                  <p className="text-[10px] font-bold text-slate-500">12,500+ Selections Guided</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs text-slate-300">
              <div className="flex items-center gap-2">
                ...
                <span>Simplifying Rajasthan History & Art-Culture</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-yellow-400 shrink-0" />
                <span>Author of Bestselling General Science Guide</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-yellow-400 shrink-0" />
                <span>50M+ Views across Educational Lectures</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-yellow-400 shrink-0" />
                <span>Dedicated Live Doubt Sessions</span>
              </div>
            </div>

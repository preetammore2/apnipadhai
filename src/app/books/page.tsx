...
import { Star, ShoppingCart, Eye, Search, Truck, ShieldCheck, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <div className="relative max-w-md mx-auto mt-6">
            ...
            <input
              type="text"
              placeholder="Search books (e.g. Science, Hindi, English, Ankganit)..."
              value={searchQuery}
